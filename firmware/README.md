...
Download **[MPE_Firmware-V1.0.5.hex](MPE_Firmware-V1.0.5.hex)** for TeensyROM+
Fab0.4 with Teensy 4.1 and a C64/128. This complete image combines the Custom GUI
and native MHS Power Engine, internally recorded as **native13**.
...
About identifies **MPE Firmware V1.0.5**, **John Swiderski**, and
**Mean Hamster Software**.

## Release record

Firmware SHA-256: `acdba317c36e022d6f3458dade1b4c2663f098772bdde7cb6f197cd799730f9d`

The [release manifest](../releases/native13/manifest.json),
[source lock](../docs/firmware/source.lock.json), and
[checksums](../docs/firmware/SHA256SUMS.txt) identify the exact image.
The [official restore image](../releases/native13/TeensyROM+_0.8_OFFICIAL-RESTORE_full.hex)
and older release kits remain available in the versioned release folders.

See [V1.0.5 validation](../docs/validation/MPE-V1.0.5.md) for executed desktop
...
increment the final number (`V1.0.6`, `V1.0.7`, ...), using
