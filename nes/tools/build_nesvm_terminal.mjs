...
const text={title:'MHS NESVM - WAITING FOR TEENSY',footer:'P2:A SPACE:B RETURN:START SHIFT:SELECT',loading:'MHS NESVM LOADING'};
...
const manifest={format:'M3TP-NESVM-terminal',diagnosticTitle:text.title,diagnosticFooter:text.footer,loadingText:text.loading,
  ...
  codeEnd:terminal.codeEnd,stageAddress:terminal.stageAddress,labels:terminal.labels,inputProtocol:'NES-INPUT-V1',
  inputFields:NES_INPUT,sharpDefault:true,romDirectory:'/NESVM/ROMS',saveDirectory:'/NESVM/SAVES',
