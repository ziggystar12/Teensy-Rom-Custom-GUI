...
for (const name of ['native05', 'native06', 'native07', 'native08', 'native09', 'native10', 'native11', 'native12', 'native13', 'native14']) {
...
for (const name of ['native10', 'native11', 'native12', 'native13', 'native14']) {
...
test('the complete selected GUI source and reviewed backend identify the current firmware version', () => {
  ...
  assert.equal(policy.testFiles.length, 29);
  assert.equal(required.length, 112);
