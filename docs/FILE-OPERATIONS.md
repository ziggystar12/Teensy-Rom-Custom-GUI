...
[MPE_Firmware-V1.0.5.hex](../firmware/MPE_Firmware-V1.0.5.hex)
is the combined V1.0.5 / native13 image for TeensyROM+ Fab0.4. Install the complete
...
The [V1.0.5 MHS Power Engine kit](../firmware/README.md) combines these file operations
with a four-by-four scrolling browser, shared bitmap dialogs, and native
AGI ego sprites. V1.0.5 retains the current game packages and save identities.
...
[the native13 manifest](../releases/native13/manifest.json) for the combined image's source
...
historical build. Use the [firmware release notes](../firmware/README.md) and native13
...
[official restore image](../releases/native13/TeensyROM+_0.8_OFFICIAL-RESTORE_full.hex) remains available.
