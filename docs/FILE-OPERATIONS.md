...
[MPE_Firmware-V1.0.2.hex](../firmware/MPE_Firmware-V1.0.2.hex)
is the combined V1.0.2 / native10 image for TeensyROM+ Fab0.4. Install the complete
...
The [V1.0.2 MHS Power Engine kit](../firmware/README.md) combines these file operations
...
[the native10 manifest](../releases/native10/manifest.json) for the combined image's source
...
historical build. Use the [firmware release notes](../firmware/README.md) and native10
...
[official restore image](../releases/native10/TeensyROM+_0.8_OFFICIAL-RESTORE_full.hex) remains available.
