...
[MPE_Firmware-V1.0.6.hex](../firmware/MPE_Firmware-V1.0.6.hex)
is the combined V1.0.6 / native14 image for TeensyROM+ Fab0.4. Install the complete
...
The [V1.0.6 MHS Power Engine kit](../firmware/README.md) combines these file operations
with a four-by-four scrolling browser, shared bitmap dialogs, and native
AGI ego sprites. V1.0.6 retains the current game packages and save identities.
...
[the native14 manifest](../releases/native14/manifest.json) for the combined image's source
...
historical build. Use the [firmware release notes](../firmware/README.md) and native14
...
[official restore image](../releases/native14/TeensyROM+_0.8_OFFICIAL-RESTORE_full.hex) remains available.
