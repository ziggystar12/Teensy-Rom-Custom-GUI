...
is the combined native09 image for TeensyROM+ Fab0.4. Install the complete
...
The [native09 MHS Power Engine kit](../firmware/README.md) combines these file operations
and the current desktop navigation/loading improvements with the native07
