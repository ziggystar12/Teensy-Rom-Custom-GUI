...
desktopMachine({diagnostic:console.log},async({s,fresh})=>{
 for(const surface of [0,1]){
  ...
  const names=['Games','Utilities','Documents','SAVES','SQ1-64-MPE.crt','KQ1-64-MPE.crt','BlackCauldron.crt','Text.txt','Readme.md','MPE_Firmwar...1.0.8.hex','DeathIsNoEvil.sid','Music','Disk01.d64','Arcada.sav','Demo.prg','Notes.txt'];
