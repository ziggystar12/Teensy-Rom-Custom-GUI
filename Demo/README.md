...
1. Install the [current MPE firmware](../firmware/README.md), or another
   compatible release newer than V1.0.2. Follow the
...
With firmware V1.0.7, this edition saves to **`SAVES/MPE4-E92AE8A6.sav`**
