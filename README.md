...
guest CGA mode. Install the paired **R22** CRT while preserving drives. R22
requests a quiet firmware window for an unstable bootstrap packet and measures
its two-frame settling delay from the live VIC raster. This corrects R20's
pre-IRQ timeout and R21's exhausted immediate rereads. Existing V1.0.17 users
